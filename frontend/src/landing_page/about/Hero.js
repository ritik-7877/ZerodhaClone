...
function Hero() {
    return (
        <div className='container'>
            ...
            <div className='row p-5 mt-5 border-top text-muted fs-6' style={{lineHeight:'1.8',fontSize:"normal"}} >
                ...
                <div className="col-6 p-5"> 
                    ...
                    <p>
                        ...
                        updates on our blog or see what the media is saying about us or learn more about 
